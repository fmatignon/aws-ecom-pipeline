...
Each entry describes catalog metadata that downstream generators reuse when constructing
timelines of product introductions, pricing tiers, and attribute combinations.
"""
        ...
        "Laptops": {
            ...
            "products": [
                ...
                },
                {
                    ...
                    "price_range": (850, 1700),
                    "colors": ["Black", "Silver", "Gray", "Navy"],
                },
            ],
        },
        "Phones": {
            ...
            "products": [
                {
                    ...
                    "colors": ["Black", "Silver", "Blue", "White", "Rose Gold"],
                },
                {
                ...
                },
                {
                    ...
                    "colors": ["Black", "Silver", "Space Gray", "Blue", "Purple"],
                },
                {
                    "name": "Foldable Phone",
            ...
            "products": [
                {
                    "name": "10-inch Tablet",
                    "price_range": (350, 900),
                    "colors": ["Silver", "Space Gray", "Black", "Blue"],
                },
                {
                    "name": "Kids Tablet",
                    "price_range": (100, 299),
                    "colors": ["Blue", "Pink", "Green", "Yellow", "Red"],
                },
                {
                    "name": "Pro Tablet",
                    "price_range": (900, 1700),
        ...
        "Men": {
            ...
            "products": [
                ...
                },
                {
                    "name": "Slim Fit Jeans",
                    "price_range": (40, 120),
                    "colors": ["Dark Blue", "Black", "Light Blue", "Gray", "Indigo"],
                },
                {
                    "name": "Lightweight Jacket",
                    "price_range": (50, 180),
                    "colors": ["Black", "Navy", "Olive", "Gray", "Brown", "Charcoal"],
                },
                {
                    "name": "Casual Button-Up",
                    "price_range": (30, 100),
                    "colors": ["White", "Blue", "Gray", "Navy", "Black", "Beige"],
                },
            ],
        },
        "Women": {
            ...
            "products": [
                ...
                },
                {
                    "name": "Wool Coat",
                    "price_range": (85, 320),
                    "colors": ["Black", "Camel", "Gray", "Navy", "Beige", "Burgundy"],
                },
                {
                    "name": "Silk Blouse",
                    "price_range": (40, 130),
                    "colors": ["White", "Black", "Navy", "Pink", "Burgundy", "Ivory"],
                },
            ],
        },
        "Kids": {
            ...
            "products": [
                ...
                },
                {
                    "name": "Play Shorts",
                    "price_range": (12, 38),
                    "colors": ["Navy", "Khaki", "Red", "Blue", "Green", "Gray"],
                },
            ],
        },
        "Shoes": {
            ...
            "products": [
                {
                    ...
                    "price_range": (45, 150),
                    "colors": ["Black", "White", "Gray", "Navy", "Red", "Blue"],
                },
                {
                    "name": "Leather Boots",
                    "price_range": (65, 220),
                    "colors": ["Brown", "Black", "Tan", "Gray", "Navy"],
                },
                {
                ...
                },
                {
                    "name": "Trail Shoes",
                    "price_range": (50, 175),
                    "colors": ["Black", "Gray", "Olive", "Brown", "Navy", "Orange"],
                },
            ],
        },
        "Accessories": {
            ...
            "products": [
                ...
                },
                {
                    "name": "Wool Scarf",
                    "price_range": (20, 90),
                    "colors": ["Gray", "Navy", "Burgundy", "Camel", "Black", "Plaid"],
                },
                {
                    "name": "Leather Wallet",
                    "price_range": (30, 120),
                ...
                },
                {
                    ...
                    "price_range": (35, 180),
                    "colors": ["Black", "Brown", "Gold", "Silver", "Tortoise"],
                },
            ],
        },
    },
            ...
            "products": [
                {
                    ...
                    "colors": ["Gray", "Beige", "Navy", "Brown", "Black", "Cream"],
                },
                {
                    "name": "Extendable Dining Table",
                    "price_range": (350, 1200),
                    "colors": ["Brown", "Oak", "Walnut", "Black", "White", "Espresso"],
                },
                {
                ...
                },
                {
                    ...
                    "price_range": (80, 350),
                    "colors": ["Brown", "Gray", "Navy", "Beige", "Black", "Cream"],
                },
            ],
        },
        "Kitchen": {
            ...
            "products": [
                ...
                },
                {
                    "name": "Chef Knife Set",
                    "price_range": (45, 300),
                    "colors": ["Stainless Steel", "Black Handle", "Wood Handle"],
                },
                {
            ...
            "products": [
                {
                    ...
                    "price_range": (60, 280),
                    "colors": ["White", "Gray", "Beige", "Ivory"],
                },
                {
                    "name": "All-Season Comforter",
                    "price_range": (50, 220),
                    "colors": ["White", "Gray", "Navy", "Beige", "Sage", "Cream"],
                },
                {
                    "name": "Organic Sheet Set",
                    "price_range": (55, 200),
                    "colors": ["White", "Ivory", "Gray", "Beige", "Sage", "Navy"],
                },
                {
                    "name": "Weighted Blanket",
                    "price_range": (80, 280),
                    "colors": ["Gray", "Navy", "Beige", "Sage", "Charcoal", "Cream"],
                },
            ],
        },
        "Decor": {
            ...
            "products": [
                ...
                },
                {
                    ...
                    "price_range": (18, 85),
                    "colors": ["White", "Terracotta", "Gray", "Blue", "Green", "Beige"],
                },
                {
                    "name": "Glass Table Lamp",
                    "price_range": (40, 180),
                    "colors": ["White", "Black", "Gold", "Silver", "Brass", "Crystal"],
                },
                {
            ...
            "products": [
                {
                    ...
                    "price_range": (250, 700),
                    "colors": ["Blue", "Teal", "White", "Gray", "Orange"],
                },
                {
                    "name": "Camping Tent",
                    "price_range": (75, 350),
                    "colors": ["Green", "Gray", "Blue", "Orange", "Brown"],
                },
                {
                    "name": "Hiking Backpack",
                    "price_range": (40, 200),
                    "colors": ["Black", "Gray", "Green", "Blue", "Orange", "Red"],
                },
                {
                    "name": "Compact Cooler",
                    "price_range": (35, 150),
                    "colors": ["Blue", "Red", "Gray", "Black", "Orange", "Green"],
                },
            ],
        },
        "Team Sports": {
            ...
            "products": [
                ...
                {
                    "name": "Carbon Fiber Hockey Stick",
                    "price_range": (90, 250),
        ...
        "Athletic Wear": {
            ...
            "products": [
                ...
                },
                {
                    ...
                    "price_range": (45, 140),
                    "colors": ["Black", "Navy", "Gray", "Red", "Yellow", "Blue"],
                },
                {
                    "name": "Moisture-Wicking Shorts",
                    "price_range": (18, 55),
                    "colors": ["Black", "Navy", "Gray", "Red", "Blue", "Charcoal"],
                },
            ],
        },
    },
        ...
        "Action Figures": {
            ...
            "products": [
                ...
                },
                {
                    "name": "Robot Warrior",
                    "price_range": (15, 45),
                    "colors": ["Silver", "Black", "Blue", "Red", "Gray"],
                },
                {
                    "name": "Fantasy Figure Set",
                    "price_range": (20, 60),
                    "colors": ["Multi-Color", "Purple", "Blue", "Green", "Gold"],
                },
                {
                    "name": "Space Explorer Set",
                    "price_range": (18, 55),
                    "colors": ["White", "Silver", "Blue", "Black", "Orange"],
                },
            ],
        },
        "Board Games": {
            ...
            "products": [
                {
                    ...
                    "price_range": (20, 55),
                    "colors": ["Multi-Color", "Blue", "Red", "Green", "Brown"],
                },
                {
                    "name": "Family Trivia Game",
                    "price_range": (15, 40),
                    "colors": ["Multi-Color", "Blue", "Red", "Yellow", "Green"],
                },
                {
                ...
                {
                    "name": "Card Battle Set",
                    "price_range": (10, 30),
                    "colors": ["Red", "Blue", "Black", "Gold", "Silver"],
                },
            ],
        },
        "Educational": {
            ...
            "products": [
                {
                    "name": "STEM Experiment Kit",
                    "price_range": (25, 65),
                    "colors": ["Blue", "Red", "Yellow", "Green", "Multi-Color"],
                },
                {
                    "name": "Coding Robot",
                    "price_range": (30, 90),
            ...
            "products": [
                {
                    "name": "Kids Scooter",
                    "price_range": (35, 85),
                    "colors": ["Red", "Blue", "Pink", "Green", "Yellow", "Orange"],
                },
                {
                    "name": "Backyard Playset",
                    "price_range": (100, 350),
                    "colors": ["Natural Wood", "Green", "Blue", "Red", "Multi-Color"],
                },
                {
                    "name": "Bubble Machine",
                    "price_range": (12, 32),
                    "colors": ["Blue", "Pink", "Yellow", "Green", "Red", "Purple"],
                },
                {
                    "name": "Water Blaster Pack",
                    "price_range": (18, 45),
                    "colors": [
                        "Blue",
                        "Orange",
        ...
        "Makeup": {
            ...
            "products": [
                ...
                },
                {
                    ...
                    "price_range": (16, 45),
                    "colors": ["Neutral", "Warm", "Cool", "Smoky", "Colorful", "Nude"],
                },
                {
                    "name": "Matte Lipstick Set",
                    "price_range": (14, 35),
                    "colors": ["Red", "Pink", "Nude", "Berry", "Coral", "Burgundy"],
                },
                {
                    "name": "Brow Sculpting Kit",
                    "price_range": (13, 38),
                    "colors": [
                        "Blonde",
                        "Brown",
        ...
        "Toys": {
            ...
            "products": [
                ...
                },
                {
                    ...
                    "price_range": (10, 28),
                    "colors": ["Blue", "Green", "Yellow", "Red", "Multi-Color"],
                },
                {
                    "name": "Feather Wand Toy",
                    "price_range": (5, 12),
                    "colors": ["Multi-Color", "Red", "Blue", "Green", "Yellow"],
                },
                {
            ...
            "products": [
                {
                    ...
                    "price_range": (15, 38),
                    "colors": ["Black", "Navy", "Red", "Blue", "Pink", "Gray"],
                },
                {
                    "name": "Travel Pet Carrier",
                    "price_range": (30, 80),
                    "colors": ["Black", "Gray", "Navy", "Red", "Blue", "Pink"],
                },
                {
                    "name": "Memory Foam Pet Bed",
                    "price_range": (40, 110),
                    "colors": ["Gray", "Beige", "Navy", "Brown", "Tan", "Cream"],
                },
                {
                    "name": "No-Pull Leash",
                    "price_range": (12, 30),
