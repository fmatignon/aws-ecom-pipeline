...
# Generation volumes are derived from the configured time range.
# Daily baselines mirror the values that drove the original 540-day simulation.
...
# Shipping carriers
CARRIERS = {"UPS": 0.40, "FedEx": 0.35, "USPS": 0.20, "DHL": 0.05}
...
# Card brands
CARD_BRANDS = {"visa": 0.50, "mastercard": 0.30, "amex": 0.15, "discover": 0.05}
...
COUNTRIES = {
    ...
    "Canada": {"weight": 0.13, "tax_rate": 0.13, "shipping_cost_range": (8.0, 18.0)},
    "United Kingdom": {
        "weight": 0.10,
        "tax_rate": 0.20,
        "shipping_cost_range": (10.0, 25.0),
    },
    "Germany": {"weight": 0.05, "tax_rate": 0.19, "shipping_cost_range": (10.0, 25.0)},
    "France": {"weight": 0.04, "tax_rate": 0.20, "shipping_cost_range": (10.0, 25.0)},
    "Italy": {"weight": 0.02, "tax_rate": 0.22, "shipping_cost_range": (10.0, 25.0)},
    "Spain": {"weight": 0.02, "tax_rate": 0.21, "shipping_cost_range": (10.0, 25.0)},
    "Japan": {"weight": 0.02, "tax_rate": 0.10, "shipping_cost_range": (12.0, 30.0)},
    "Netherlands": {
        "weight": 0.01,
        "tax_rate": 0.21,
        "shipping_cost_range": (10.0, 25.0),
...
# Business period multipliers (for ongoing runs)
BUSINESS_PERIODS = {
    "good": {
        "name": "Good Period",
        "multiplier": 1.1,  # 10% more activity
        "probability": 0.3,  # 30% chance
    },
    "normal": {
        "name": "Normal Period",
        "multiplier": 0.9,  # Almost historical activity
        "probability": 0.5,  # 50% chance
    },
    "bad": {
        "name": "Bad Period",
        "multiplier": 0.4,  # 60% less activity
...
CUSTOMER_SEGMENTS = {
    ...
    "Regular": {"discount_rate": 0.05, "free_shipping_threshold": 50.0},
    "VIP": {"discount_rate": 0.10, "free_shipping_threshold": 20.0},
}
...
# Customer category preference distribution
...
ORDER_DATE_DISTRIBUTION_PEAK = (
    0.3  # Peak of triangular distribution (30% of time range)
)
...
ORDER_STATUS_TRANSITION_WEIGHTS = {
    "shipped_delivered": [
        0.3,
        0.7,
    ],  # [shipped, delivered] weights for medium-old orders
