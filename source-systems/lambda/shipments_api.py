        ...
        if 'Contents' in page:
            for obj in page['Contents']:
                if obj['Key'].endswith('.parquet'):
                    # Extract date from the key path: source/shipments/date=YYYY-MM-DD/...
                    try:
                        # Key format: source/shipments/date=YYYY-MM-DD/filename.parquet
